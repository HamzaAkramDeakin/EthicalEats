...
static final int REQUEST_IMAGE_CAPTURE = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultIV = findViewById(R.id.halatext2);
    ...
    private boolean checkPermissions(){
        int camerapermit = ContextCompat.checkSelfPermission(getApplicationContext(),CAMERA);
        return camerapermit == PackageManager.PERMISSION_GRANTED;
    }
        ...
        Task<Text> result = recognizer.process(image).addOnSuccessListener(new OnSuccessListener<Text>() {
            ...
            public void onSuccess(@NonNull Text text) {
                ...
                for(Text.TextBlock block: text.getTextBlocks()){
                    ...
                    Rect blocFrame = block.getBoundingBox();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(HalalActivity.this, "Failed to detect halal"+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
